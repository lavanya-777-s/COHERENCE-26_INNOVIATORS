        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., 500"
              className="w-full border-2 border-gray-300 rounded-lg px-4 py-3 font-medium focus:border-blue-600 focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              className="w-full border-2 border-gray-300 rounded-lg px-4 py-3 font-medium focus:border-blue-600 focus:outline-none resize-none"
            ></textarea>
          </div>
